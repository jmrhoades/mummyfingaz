...
//I've added the exponent function as a float uniform, so you can change the value yourself in the host app, VDMX!
...
void main() {
	...
	float y = pow(normalized_screen.x,level);
